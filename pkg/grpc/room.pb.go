...
// The request message containing the player's current coordinates
...
// The response message containing the room's details
type RoomResponse struct {
	...
	Npcs        []string `protobuf:"bytes,3,rep,name=npcs,proto3" json:"npcs,omitempty"`
}
...
func (x *RoomResponse) GetItems() []string {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *RoomResponse) GetNpcs() []string {
	if x != nil {
		return x.Npcs
	}
	return nil
...
var file_room_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x72, 0x6f, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x67, 0x72,
	0x70, 0x63, 0x22, 0x37, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x01, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x7a, 0x22, 0x5a, 0x0a, 0x0c, 0x52,
	0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64,
	...
	0x65, 0x6d, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x70, 0x63, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x70, 0x63, 0x73, 0x32, 0x3f, 0x0a, 0x0b, 0x52, 0x6f, 0x6f, 0x6d, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6f,
	0x6d, 0x12, 0x11, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x6f, 0x6d,
...
var file_room_proto_goTypes = []interface{}{
	(*RoomRequest)(nil),  // 0: grpc.RoomRequest
	(*RoomResponse)(nil), // 1: grpc.RoomResponse
}
var file_room_proto_depIdxs = []int32{
	0, // 0: grpc.RoomService.GetRoom:input_type -> grpc.RoomRequest
	1, // 1: grpc.RoomService.GetRoom:output_type -> grpc.RoomResponse

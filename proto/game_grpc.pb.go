...
const (
	Game_CreatePlayer_FullMethodName = "/game.Game/CreatePlayer"
	Game_MovePlayer_FullMethodName   = "/game.Game/MovePlayer"
	Game_GetLocation_FullMethodName  = "/game.Game/GetLocation"
)

...
const (
	Game_CreatePlayer_FullMethodName = "/dnd.Game/CreatePlayer"
	Game_MovePlayer_FullMethodName   = "/dnd.Game/MovePlayer"
	Game_GetLocation_FullMethodName  = "/dnd.Game/GetLocation"
)
